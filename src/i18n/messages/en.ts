...
export const en = {
  ...
  experience: {
    ...
    items: [
      ...
      {
        title: 'Project Developer & Mentor',
        company: 'Korea Software HRD Center',
        type: 'Project-based',
        duration: '2024 - Present',
        location: 'Cambodia',
        description: [
          'Built Assessify as a student — an employee evaluation system streamlining performance assessments (ranked Top 2 of 8) — Figma, UX research, prototyping',
          'Built PipeJet as a student — an automated deployment platform focused on developer workflow (ranked Top 3 of 6) — Figma, user journey mapping',
          'Mentored the ZenTrio team — a task management system for team collaboration and productivity (ranked Top 1 of 8)',
          'Mentored the EduTrace team — a connected learning platform for KSHRD with task tracking, meeting rooms, assessments, and AI-powered progress reports (ranked Top 1 of 6)',
        ],
        technologies: [
          'Figma',
          'UX Research',
      ...
      },
      {
        ...
        location: 'Cambodia',
        description: [
          'Adopted Claude Code as a daily engineering teammate — from feature work and refactoring to code review and deployment',
          'Engineered AI-native development environments with custom subagents, skills, and quality hooks that make the assistant project-aware and governed',
          'Structured a Next.js + Spring Boot monorepo with CLAUDE.md project briefs and per-feature memory so AI agents follow team conventions',
          'Use ChatGPT, Claude AI, and Cursor daily for design exploration, debugging, and documentation',
        ],
        technologies: [
          'Claude Code',
          'Claude AI',
