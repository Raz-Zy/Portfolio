...
export default function GitHub() {
  ...
  const renderRepositoryCard = (repo: Repository, index: number) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white dark:bg-gray-900 rounded-2xl shadow-primary p-4 sm:p-6 card-hover"
              >
                <div className="flex justify-between items-start mb-3 sm:mb-4">
                  ...
                  <a
                    ...
                    className="text-gray-500 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400 transition-colors flex-shrink-0 ml-2"
                  >
                ...
                {repo.topics && repo.topics.length > 0 && (
                  <div className="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4">
                    {repo.topics.slice(0, 3).map((topic) => (
                      <span
                        key={topic}
                        className="px-2 py-1 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 text-xs rounded-full truncate max-w-20 sm:max-w-none"
                        title={topic}
                      >
                        {topic}
                      </span>
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        {user && (
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-white dark:bg-gray-900 rounded-2xl shadow-primary p-6 sm:p-8 mb-8 sm:mb-12 max-w-4xl mx-auto"
          >
            <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
              <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden shadow-primary flex-shrink-0">
                <img 
                  src={user.avatar_url}
        ...
        {selectedOrg ? (
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6 sm:mb-8">
              <button
                ...
                className="flex items-center gap-2 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors text-sm sm:text-base"
              >
                <FaArrowLeft />
                {t('github.backToOrgs')}
              </button>
          ...
          <div>
            ...
            >
              <div className="bg-white dark:bg-gray-900 rounded-full p-1 sm:p-2 shadow-primary w-full max-w-md">
              ...
              >
                {organizations.map((org, index) => (
                  <motion.div
                    ...
                    className="bg-white dark:bg-gray-900 rounded-2xl shadow-primary p-4 sm:p-6 card-hover cursor-pointer"
                  >
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gradient-to-r from-primary-600 to-accent-600 dark:from-primary-500 dark:to-accent-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:from-primary-700 hover:to-accent-700 dark:hover:from-primary-600 dark:hover:to-accent-600 transition-all duration-300 inline-flex items-center gap-2 shadow-primary hover:shadow-primary-lg text-sm sm:text-base"
          >
            <FaCode />
            {t('github.viewAll')}
          </a>
