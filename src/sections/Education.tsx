        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            {m.education.items.map((item, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-6 w-4 h-4 bg-gradient-to-br from-primary-500 to-accent-500 rounded-full border-4 border-white dark:border-gray-800 shadow-primary"></div>
                
                {/* Content card */}
                <div className="ml-16 glass-card p-8 rounded-2xl shadow-primary card-hover w-full">
