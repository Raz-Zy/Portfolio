      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl shadow-primary card-hover">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl shadow-primary card-hover">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 bg-accent-100 dark:bg-accent-900 rounded-full flex items-center justify-center">
                  <FaHeart className="text-accent-600 dark:text-accent-400" />
                </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-gradient-to-br from-primary-500 to-accent-500 p-8 rounded-2xl text-white card-hover">
